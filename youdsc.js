...
(function () {
    var a = {createNode: function (d, c, f) {
        var b = f || document;
...
(function (c, a) {
    function b() {
        ...
        function e() {
            ...
            c.css(j, {"background-color": "white", border: "0", width: a.getWidth("full") + "px", height: a.getHeight("full") + "px"});
            if (c.browser.msie) {
        ...
        function d(m, n) {
            if (n === false) {
                ...
                c.css(document.getElementById("YOUDAO_SELECTOR_IFRAME"), {width: a.getWidth("full") + "px", height: a.getHeight("full") + "px"})
            }
            ...
            if (l !== null) {
                ...
                c.css(m.getElementById("bgTopRight"), {width: a.getWidth("half") + "px", height: a.getHeight("half") + "px"});
                c.css(m.getElementById("bgBottom"), {height: (a.getHeight("full") - a.getHeight("half")) + "px"});
                c.css(m.getElementById("bgBottomRight"), {width: a.getWidth("half") + "px", height: (a.getHeight("full") - a.getHeight("half")) + "px"})
            }
            ...
            c.css(m.getElementById("result"), {"border-color": a.borderColor, width: a.getWidth("result") + "px", height: a.getHeight("result") + "px"})
        }
...
(function (b) {
    var a = {renderTranslation: function (g, d, j) {
    ...
    function b() {
        ...
        function g() {
            ...
            if (v !== null) {
                ...
                e.css(v, {margin: 0, border: 0, padding: 0, backgroundImage: "url(http://shared.ydstatic.com/api/1.0/switcher.png)", width: "20px", height: "40px", cursor: "pointer"});
                a.select = "off";
        ...
        function t(w) {
            ...
            x.setAttribute("src", "http://fanyi.youdao.com/openapi.do?type=data&doctype=jsonp&version=1.1&" + e.parameter({relatedUrl: a.relatedUrl, keyfrom: "tuicool", key: "974115503", callback: y, translate: a.translate, q: w, ts: (new Date()).getTime()}));
        ...
        function q(w) {
            ...
            var x = document.createElement("script");
            x.setAttribute("type", "text/javascript");
            x.setAttribute("src", "http://fanyi.youdao.com/openapi.do?type=data&only=on&doctype=jsonp&version=1.1&" + e.parameter({relatedUrl: a.relatedUrl, keyfrom: "tuicool", key: "974115503", callback: y, q: w, ts: (new Date()).getTime()}));
            x.setAttribute("charset", "utf-8");
            var v = document.getElementsByTagName("head")[0] || document.body;
            v.appendChild(x)
        }
